...
exports.validacionesdb = exports.devoluciones = exports.inventario_servicios = exports.inventario = exports.ubicacion = exports.producto = exports.Servicio = exports.pedido = exports.b_p = exports.Usuario = exports.Role = void 0;
...
class validacionesdb {
    constructor() {
        ...
        this.existeservicio = (id) => __awaiter(this, void 0, void 0, function* () {
            const existeservicio = yield exports.Servicio.findOne({ 'descripcion': id });
            if (existeservicio) {
                throw new Error(`ya existe el servicio${id}`);
            }
        });
        this.existeproducto = (id) => __awaiter(this, void 0, void 0, function* () {
            const existeproducto = yield exports.producto.findOne({ 'descripcion': id.toUpperCase() });
            if (existeproducto) {
        ...
        this.existeinventario = (id) => __awaiter(this, void 0, void 0, function* () {
            const inv = yield exports.inventario.findById(id);
        ...
        this.existeinventarioprod = (id) => __awaiter(this, void 0, void 0, function* () {
            const existeinv = yield exports.inventario.findOne({ $and: [{ 'id_producto': id }, { 'ubicacion': this.id_ubicacion }] });
            if (existeinv) {
        ...
        this.existeinventarioservicio = (id) => __awaiter(this, void 0, void 0, function* () {
            const existeinv = yield exports.inventario_servicios.findOne({ $and: [{ 'id_servicio': id }, { 'ubicacion': this.ubicacion }] });
            if (existeinv) {
        ...
        this.esproductodevuelto = (id) => __awaiter(this, void 0, void 0, function* () {
            console.log(id);
            const existeinv = yield exports.producto.find({ 'descripcion': id });
        ...
        this.existepedidob_p = (id) => __awaiter(this, void 0, void 0, function* () {
            ...
            const pedidos = yield exports.pedido.find({ $and: [{ 'id_b_p': b_ps['id_b_p'] }, { status_log: 'pendiente' }] });
