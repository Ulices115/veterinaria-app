    ...
    constructor() {
        ...
        this.actualizarorden = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (const producto in ordendetalle) {
                ...
                const inventariores = yield inventario.find({ $and: [{ 'id_producto': ordendetalle[producto]['producto'] }, { ubicacion: ubi }] });
                const nuevaexistencias = inventariores[0]['cantidad'] + ordendetalle[producto]['cantidad'];
                yield inventario.updateOne({ $and: [{ id_producto: ordendetalle[producto]['producto'] }, { ubicacion: ubi }] }, { cantidad: nuevaexistencias });
            }
        });
    }
}
