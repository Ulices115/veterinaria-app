...
// } = require('../middlewares');
const validar_roles_1 = __importDefault(require("../middlewares/validar-roles"));
...
router.put('/:id', [
    ...
    check('rol').custom(db_validators_1.default.esRoleValido),
    validar_campos_1.default.validarCampos
...
router.delete('/:id', [
    ...
    // esAdminRol,
    validar_roles_1.default.tienRol('ADMIN_ROLE', 'VENTAS_ROL'),
    check('id', 'No es un ID valido').isMongoId(),
    check('id').custom(db_validators_1.default.existeUsuarioPorId),
    validar_campos_1.default.validarCampos
